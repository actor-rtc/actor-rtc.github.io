...
sequenceDiagram
    ...
    Note right of ais: CurrentKeyCache:<br/>  key_id: u32<br/>  public_key: String<br/>  last_updated: u64<br/>  TTL: 600s (10分钟)
...
**实现位置** (`actrix/crates/signaling/src/server.rs:390-400`):
...
**验证逻辑** (`actrix/crates/common/src/realm/validation.rs:18-35`):
